SlopeHunterStartupMessage <- function()
{
  ...
  \\___ \\/ /   / / / / ___/ /_  /  __  / / / / /\ \\/ / / / / /_ /   _/
 ____/ / /___/ /_/ / /  / /_  / /  / / /_/ / /  \\\ / / / / /__/ /\ \\
/_____/\\____/\\____/_/  /___/ /_/  /_/\\____/_/  \\_/ /_/ /____/_/ \\_\\  version"), utils::packageVersion("SlopeHunter"),
...
.onAttach <- function(lib, pkg)
{
  ...
  if(!interactive())
    msg[1] <- paste("Package 'SlopeHunter' version", utils::packageVersion("SlopeHunter"))
